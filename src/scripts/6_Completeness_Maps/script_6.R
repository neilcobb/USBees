...
div <- read.csv(paste(script5outputs, "AllBees30km.csv", sep = ""))
...
div <- read.csv(paste(script5outputs, "AllBees60km.csv", sep = ""))
colnames(div)[3] <- "Longitude" #make column names the same between dfs
colnames(div)[4] <- "Latitude" #make column names the same between dfs
...
div <- read.csv(paste(script5outputs, "AllBees110km.csv", sep = ""))
colnames(div)[3] <- "Longitude" #make column names the same between dfs
colnames(div)[4] <- "Latitude" #make column names the same between dfs
...
div <- read.csv(paste(script5outputs, "AllBees220km.csv", sep = ""))
colnames(div)[3] <- "Longitude" #make column names the same between dfs
colnames(div)[4] <- "Latitude" #make column names the same between dfs
